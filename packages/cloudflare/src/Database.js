 ...
 */
export const LOCAL_DATABASE_URL = "postgres://postgres:postgres@localhost:5432/effect_worker";
/**
 ...
 * ```
 */
export const makeDatabaseConnection = (connectionString) => Effect.gen(function* () {
